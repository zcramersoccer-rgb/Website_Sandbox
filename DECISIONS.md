...
|---|---|---|---|
| 27 | *"use logo B and fix the issues the audit has found"* | Logo B (emblem on white) set as the WordPress Site Icon and served at /favicon.ico. Audit: 32 findings confirmed after adversarial verification, 12 rejected. Working through them; the trailing-slash cache regression was already fixed before the report landed. | **In progress** |
